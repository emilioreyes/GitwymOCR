...
/**
 //Clase para manejar las preferencias que se guardan a través de sesiones de la aplicación, Muestra
 * Class to handle preferences that are saved across sessions of the app. Shows
 //una jerarquía de preferencias para el usuario, organizada en secciones. Estas
 * a hierarchy of preferences to the user, organized into sections. These
 // preferencias son mostradas en la opcion de menu que es mostrada cuando el usuario
