 ...
 * This activity opens the camera and does the actual scanning on a background thread. It draws a
 // esta actividada abre la camara y el escaneo actual en un hilo de fondo. esto dibuja 
 * viewfinder to help the user place the text correctly, shows feedback as the image processing
//* un viewfinder para ayudar al usuario a colocar el texto correctamente, muestra de retroalimentación como el procesamiento de imágenes 
 * is happening, and then overlays the results when a scan is successful.
 // está sucediendo, y luego superpone los resultados cuando una exploración es exitosa
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  private static final int BUSCAR = Menu.FIRST + 2;
...
//informacion para buscar y pasar a la otra actividad 
  String textoEscaneado="";
 final static String ACT_INFO = "edu.sfsu.cs.orange.ocr.InformacionActivity.java"; // Ruta y Nombre
 //----------------
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    menu.add(0, BUSCAR, 0, "Buscar").setIcon(android.R.drawable.ic_search_category_default);
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    case BUSCAR:{
   	 if(textoEscaneado.equals("")){
   		 Toast toast = Toast.makeText(this, "Antes de continuar,primero escanee el texto", Toast.LENGTH_SHORT);
   	      toast.setGravity(Gravity.TOP, 0, 0);
   	      toast.show(); 
   	 }
   	 else{
   	Intent activity = new Intent(this, InformacionActivity.class);
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    textoEscaneado=(String) ocrResultTextView.getText();
    return true;
  }
